...
import { formatDuration, formatMissing, formatNumber } from "@/lib/format";
import type { Metric } from "@/lib/types";

function formatDelta(delta: number, format: Metric["format"]) {
  if (format === "duration") {
